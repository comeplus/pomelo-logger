...
var categoryNamesConfigured = [];

function getLogger(categoryName) {
	var args = categoryNamesConfigured.concat(Array.prototype.slice.call(arguments, 1));
 ...
 * @param  {Array} categoryNames optional, configured category names which will be append to log line
 * @return {Void}
 */

function configure(config, opts, _categoryNames) {
	var filename = config;
	config = config || process.env.LOG4JS_CONFIG;
	opts = opts || {};
	categoryNamesConfigured = _categoryNames || [];
