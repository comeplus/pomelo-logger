...
var categoryNamesAtHead = [];
var categoryNamesAtEnd = [];

function getLogger(categoryName) {
	var args = categoryNamesAtHead.concat(Array.prototype.slice.call(arguments, 1));
	args = args.concat(categoryNamesAtEnd);
 ...
 * @param  {Array} categoryNamesAtHead optional, configured category names which will be insert into log line
 * @param  {Array} categoryNamesAtEnd optional, configured category names which will be append to log line
 * @return {Void}
 */

function configure(config, opts, _categoryNamesAtHead, _categoryNamesAtEnd) {
	var filename = config;
	config = config || process.env.LOG4JS_CONFIG;
	opts = opts || {};
	categoryNamesAtHead = _categoryNamesAtHead || [];
	categoryNamesAtEnd = _categoryNamesAtEnd || [];
